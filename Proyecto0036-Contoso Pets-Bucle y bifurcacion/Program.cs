                ...
                for (int i = 0; i < maxPets; i++)
                {
                    ...
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        ...
                        do
                        {
                            ...
                            string entryAge = Console.ReadLine();
                            int newAge;

                            if (int.TryParse(entryAge, out newAge))
                            {
                                ourAnimals[i, 2] = "Age: " + newAge;
                                Console.WriteLine($"New age for {ourAnimals[i, 0]} is {ourAnimals[i, 2]}");
                                entryValid = true;
                    ...
                    if (ourAnimals[i, 4] == "Physical description: ")
                    {
                        ...
                        ourAnimals[i, 4] = "Physical description: " + physicalDesc;
                        Console.WriteLine($"New description for {ourAnimals[i, 0]} is {ourAnimals[i, 4]}");
                        break;
                    }
